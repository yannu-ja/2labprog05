...
/**
 * Manages interactive user input and executes commands via the {@link CommandManager}.
...
public class ConsoleManager {
    ...
    /**
     * Constructs a {@code ConsoleManager} with a specified {@link CommandManager}.
     * Initializes a {@link Scanner} for reading user input.
     *
     * @param commandManager The command manager responsible for executing user commands.
     */
    ...
    /**
     * Retrieves the {@link Scanner} instance used for user input.
     *
